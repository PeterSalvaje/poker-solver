...
public:
    ...
    void retrain(GameTreeNode* node);
    vector<float> cfrSubtree(int player, shared_ptr<GameTreeNode> node, const vector<float>& reach_probs, int iter, uint64_t current_board,int deal); // Nueva función para recalcular un subárbol
